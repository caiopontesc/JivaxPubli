...
public class PubliServiceHelper implements IPubliServiceHelper {

	private static final String loginService = "http://apibg9.publicloud.com.br/Services/IntegracaoService.svc/Login?usuario=API2&senha=p4237&empresa=1";
	...
	private static final String publiCookie = new PubliServiceHelper().Login();
	...
	public String Login() {
		...
		try {
			...
			if (conn.getResponseCode() != 200) {
				System.out.println(
						"\n\nExcedido o limite de usuários da Base BG9PE. HTTP ERROR: " + conn.getResponseCode() + " "
